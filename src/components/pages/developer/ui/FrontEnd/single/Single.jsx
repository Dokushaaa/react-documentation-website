						...
						<div className='grid md:grid-cols-[2fr_1fr] gap-10'>
							<div className='article'>
								...
								<article>
									...
									<Markdown>{post?.data[0].post_article}</Markdown>
								</article>
							</div>
								...
								<div className='sticky top-4'>
									<div className='shadow-[4px_2px_10px_5px_rgba(0,0,0,0.1)]  p-5 rounded-2xl mb-5 '>
										<img
											...
											alt=''
											className='rounded-full size-[100px] object-cover mb-5 mx-auto'
										/>
										<h3 className='text-center'>Johnny Hale</h3>
										<p className='text-center mb-5 !leading-snug'>
											Lorem ipsum dolor sit amet consectetur adipisicing elit.
											Sint quis assumenda enim voluptatum impedit ad deserunt
											placeat laboriosam rem, dolorum cumque repellat adipisci
											ex culpa quam velit eligendi am?
										</p>
									...
									<div className='shadow-[4px_2px_10px_5px_rgba(0,0,0,0.1)]  p-5 rounded-2xl mb-5 '>
										...
										{sideIsLoading ? (
											...
											latestpost?.data.slice(0, 3).map((item, key) => (
												<div
													className='grid grid-cols-[90px_1fr] gap-3 mb-4'
													key={key}>
													<img
